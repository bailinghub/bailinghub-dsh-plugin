...
export class BailingHubAgentClientRuntime {
  ...
  definitionFor(state, run, tool) {
    ...
    return {
      name: tool.name,
      description: `${tool.description}\nBailingHub governance metadata: ${governance}. Use this loaded tool directly when the target is clear. On uncertain outcomes recover the original invocation_id; never create a replacement call.`,
