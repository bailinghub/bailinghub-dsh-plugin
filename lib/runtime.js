      ...
      switch (action) {
        case 'connections': {
          ...
          if (operation === 'add' && parameters.length === 4) {
            ...
            return {
              kind: 'success',
              text: `Connection registered and selected for new sessions: ${connectionName}\n${commandText(result)}`,
            }
          }
          ...
          return {
            kind: 'error',
            text: 'Usage: /bailinghub connections list|add <name> <hub-url> <client-app-id> <workspace>|use <name>|remove <name>',
          }
        }
        case 'doctor': {
