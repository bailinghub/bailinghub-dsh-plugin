  ...
  return {
    ...
    apply(ctx, config) {
      ...
      const runtime = new BailingHubAgentClientRuntime(
        ...
        getTransport,
        options.recovery,
        { scopeStore: options.scopeStore, archiveStore: options.archiveStore, artifactSource: options.artifactSource, artifactStore: options.artifactStore, invocationStore: options.invocationStore, toolLifecycle: options.toolLifecycle },
      ).install()
